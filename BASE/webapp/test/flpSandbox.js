		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creacion de aplicativo",
									"targetURL": "#comuppersappruebaprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comuppersappruebaprueba-display": {
								"semanticObject": "comuppersappruebaprueba",
								"action": "display",
								"description": "An SAP Fiori apllication.",
								"title": "Creacion de aplicativo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.uppersap.prueba.prueba",
									"url": sap.ui.require.toUrl("com/uppersap/prueba/prueba")
								}
							}
						}
					}
